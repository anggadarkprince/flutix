...
class MovieList extends StatefulWidget {
  ...
  MovieList({this.genre, this.query});
...
class _MovieListState extends State<MovieList> {
  ...
  Future fetchhData({reset: false}) {
    ...
    return MovieServices.getMovies(currentPage, genre: widget.genre, query: widget.query)
      .then((value) {
        if (this.mounted) {
          setState(() {
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 5),
                              Text(
                                "Released ${movies[index].releaseDate.isEmpty ? 'N/A' : DateFormat('dd MMMM yyyy').format(DateTime.tryParse(movies[index].releaseDate))}",
